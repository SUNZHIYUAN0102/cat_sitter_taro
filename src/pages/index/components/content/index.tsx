...
const Content: React.FC = () => {
    ...
    return <View>
        <View className="w-[100%] h-[400px] relative">
            ...
            <View className="absolute w-[300px] right-[30px] top-[55px]">
                <Button style={{ visibility: user.token ? "visible" : "hidden" }} onClick={toRequestPage} className="w-[180px] px-[10px] ml-[10px] mb-[20px] bg-orange-600 rounded-sm text-white text-[18px] cursor-pointer">
                    Find a sitter
                </Button>

                <View className="p-[10px] rounded-md backdrop-blur-[8px]">
